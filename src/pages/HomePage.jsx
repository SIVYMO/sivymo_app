...
export default function HomePage() {
        ...
        <div className="col-12 md:col-6 p-card shadow-2 ">
            <div className="flex justify-content-center align-items-center h-15rem">
                <div className='text-center'>
                    ...
                    <div className='font-bold text-3xl'>{moment(value).format("LLLL")}</div>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <>
            <h1>{txtWelcome}{' '} {`${userInfo.nombre} ${userInfo.primerApellido}`}</h1>
            <div className="grid">
                <div className={`col-12 md:col-6 p-card shadow-2 ${resume.clientesTotales === 0 ? 'bg-pink-100': 'bg-green-200'}`}>
                    <div className="flex justify-content-center align-items-center h-15rem">
                        <div className='text-center'>
